...
class Critic(nn.Module):
    def __init__(self, state_dim, action_size, goal_dim, hidden_1=256, hidden_2=256):
        ...
        self.fc1 = nn.Linear(self.state_dim + self.goal_dim + self.action_size, self.hidden_1)
        self.fc2 = nn.Linear(self.hidden_1, self.hidden_2)
